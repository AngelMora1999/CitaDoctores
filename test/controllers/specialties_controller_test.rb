...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { color: @specialty.color, cover: @specialty.cover, description: @specialty.description, icon: @specialty.icon, logo: @specialty.logo, title: @specialty.title, visit_count: @specialty.visit_count } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { color: @specialty.color, cover: @specialty.cover, description: @specialty.description, icon: @specialty.icon, logo: @specialty.logo, title: @specialty.title, visit_count: @specialty.visit_count } }
