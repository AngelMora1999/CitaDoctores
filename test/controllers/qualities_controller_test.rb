...
class QualitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quality" do
    assert_difference('Quality.count') do
      post qualities_url, params: { quality: { color: @quality.color, description: @quality.description, icon: @quality.icon, title: @quality.title } }
    end
  ...
  test "should update quality" do
    patch quality_url(@quality), params: { quality: { color: @quality.color, description: @quality.description, icon: @quality.icon, title: @quality.title } }
